...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 01 juin 2022 à 00:38
...
CREATE TABLE IF NOT EXISTS `labo` (
  `laboid` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(30) DEFAULT NULL,
  `dispo` varchar(1) DEFAULT NULL,
